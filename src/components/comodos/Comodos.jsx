...
export function Comodos() {
    ...
    const [namesList, setNamesList] = useState([
      { title: 'Sala', names: ['Luz Central', 'TV', 'Aquecedor'], lightColors: ['red', 'red', 'red'] },
      { title: 'Cozinha', names: ['Luz central', 'liquidificador', 'geladeira'], lightColors: ['red', 'red', 'red'] },
      { title: 'Garagem', names: ['Luz central', 'Subir portão', 'Descer Portão'], lightColors: ['red', 'red', 'red'] },
      { title: 'Escritório', names: ['RGB', 'TV', 'Arcondicionado'], lightColors: ['red', 'red', 'red'] }
    ]);
    ...
    const addNewCard = () => {
      const newCard = { title: 'Cômodo', names: ['New', 'Name', 'List'], lightColors: ['red', 'red', 'red'] };
